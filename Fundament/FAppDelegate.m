...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
      self.viewController = [[[FViewController alloc] initWithNibName:@"FViewController_iPhone" bundle:nil] autorelease];
  } else {
      self.viewController = [[[FViewController alloc] initWithNibName:@"FViewController_iPad" bundle:nil] autorelease];
  }
